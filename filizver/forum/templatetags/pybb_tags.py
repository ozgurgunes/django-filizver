...
@register.simple_tag
def forum_link(object, anchor=u''):
    """
...
@register.filter
def forum_topic_moderated_by(topic, user):
    """
...
@register.filter
def forum_topic_unread(topics, user):
    """
...
@register.filter
def forum_forum_unread(forums, user):
    """
...
@register.filter
def forum_topic_inline_pagination(topic):
