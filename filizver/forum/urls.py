...
from filizver.forum.feeds import LastPosts, LastTopics
from filizver.forum.views import IndexView, CategoryView, ForumView, TopicView,\
...
urlpatterns += patterns('forum.views',
                        ...
                        # Attachment
                        #url('^attachment/(\w+)/$', 'show_attachment', name='forum_attachment'),
