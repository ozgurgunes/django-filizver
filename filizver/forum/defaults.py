...
from filizver.forum.util import filter_blanks, rstrip_str
...
PYBB_ATTACHMENT_UPLOAD_TO = getattr(settings, 'PYBB_ATTACHMENT_UPLOAD_TO', os.path.join('forum_upload', 'attachments'))

PYBB_DEFAULT_AVATAR_URL = getattr(settings,'PYBB_DEFAULT_AVATAR_URL',
    getattr(settings, 'STATIC_URL', '') + 'forum/img/default_avatar.jpg')
...
PYBB_SMILES_PREFIX = getattr(settings, 'PYBB_SMILES_PREFIX', 'forum/emoticons/')
